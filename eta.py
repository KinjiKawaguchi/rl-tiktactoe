...
if __name__ == "__main__":
    ...
    for i,eta in enumerate(etas):
        ...
        print(f"Completion: {eta}done")  # 完了率を出力
        ...
        # PNGとして保存
        plt.savefig(f"win_rate_distribution_eta{eta}_mean{mean_win_rate}_median{median_win_rate}_variance{variance}_std_deviation{std_deviation}.png")

        plt.clf()  # 描画をリセット

    # 全てのetaが処理された後、x軸に学習率、y軸に平均勝率をプロットしたグラフを作成
    plt.plot(etas, mean_win_rates)
